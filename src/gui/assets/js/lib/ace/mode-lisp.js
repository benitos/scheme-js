...
var LispHighlightRules = function() {
    ...
    supportFunctions += (
        /* Sys:  */ "display|quote|error" +
        /* Math: */ "+|-|*|\\/|" +
        /* Vars: */ "define|set!|let|lambda|begin" +
        /* Bool: */ "true|#t|false|#f|if|eq?|cons?|symbol?|number?|and|or|not|" +
        /* Cons; */ "cons|first|rest|second|third|reverse|"
    );
