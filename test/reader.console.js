...
var SchemeReaderConsole = require('../src/reader.console');
...
describe('SchemeReaderConsole', function () {
    var reader = new SchemeReaderConsole();
    ...
    it('should have a `rawInput` property', function () {
        ...
        expect(reader.rawInput).to.have.a.property('prompt');
    });
